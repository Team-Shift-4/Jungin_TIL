...
* Proof\
  이 Theorem을 증명하기 위해 $$r_1, r_2$$가 Characteristic equation의 Root임과 $$\alpha_1, \alpha_2$$가 Constant일 때 $$a_n=\alpha_1r_1^n+\alpha_2r_2^n$$인 Sequence $$\{a_n\}$$이 Recurrence relation의 Solution임을 보여야 하며(1), Sequence $$\{a_n\}$$이 Solution일 경우 어떤 Constant $$\alpha_1, \alpha_2$$에 대해 $$a_n=\alpha_1r_1^n+\alpha_2r_2^n$$임을 보여야 한다.\
